...
<div class="panel">
  ...
  <div class="row2"><label><input type="checkbox" id="cBounds"> show bounds</label></div>
  <div id="controls"></div>
...
<script>
  ...
  function apply(){
    ...
    S.setProperty("--left",(st.left*PXVW).toFixed(1)+"px");S.setProperty("--top",(st.top*PXVH).toFixed(1)+"px");
