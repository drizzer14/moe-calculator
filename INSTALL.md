...
2. Run **`MoECalculator-Setup-1.1.0.exe`**.
...
3. Copy **`com.14th_ua.moe_calculator_1.1.0.wotmod`** into that folder.
...
`com.14th_ua.moe_calculator_1.1.0.wotmod`, and (optionally) the ModsSettingsAPI `.wotmod`.
...
`com.14th_ua.moe_calculator_1.1.0.wotmod` from `mods\<version>\`, then restart the client.
