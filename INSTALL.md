...
2. Run **`MoECalculator-Setup-0.2.0.exe`**.
...
3. Copy **`com.14th_ua.moe_calculator_0.2.0.wotmod`** into that folder.
...
`com.14th_ua.moe_calculator_0.2.0.wotmod`.
...
`com.14th_ua.moe_calculator_0.2.0.wotmod` from `mods\<version>\`, then restart the client.
